<template>
  <div>
    <el-card>
      <div slot="header">
        <Icon type="md-aperture" size="30" color="#2e71ea" />
        <span class="clearfix">今日头条</span>
        <Dropdown style="margin-left:50px;">
          <a href="javascript:void(0)">
            <span>切换媒体</span>
            <Icon size="20" type="ios-arrow-down"  />
          </a>
        ...
        <el-card style="margin-top:30px;">
                ...
                <el-col :span="8">
                  <FormItem prop="applicationTop">
                    <el-select v-model="searchFormTop.applicationTop" filterable placeholder="请选择应用">
                      ...
                      <el-option v-for="(item, index) in applicationList" :key="index" :value="item">{{ item }}
                      </el-option>
                    </el-select>
                  </FormItem>
                </el-col>
                ...
                <el-col :span="8">
                  <FormItem prop="mediaTypeTop">
                    <el-select v-model="searchFormTop.mediaTypeTop" filterable placeholder="请选择媒体">
                      <el-option v-for="(item, index) in mediaTypeList" :key="index" :value="item">{{ item }}
                      </el-option>
                    </el-select>
                  </FormItem>
                </el-col>
                ...
                <el-col :span="8">
                  <FormItem prop="dateTop">
                    <el-select v-model="searchFormTop.dateTop" filterable placeholder="请选择日期">
                      <el-option v-for="(item, index) in dateSelectList" :key="index" :value="item">{{ item }}
                      </el-option>
                    </el-select>
                  </FormItem>
                </el-col>
          ...
          <div>
            <el-table :data="tableDataTopAd" border>
              ...
              <el-table-column v-for="(item, index) in columnTopAd" :key="index" :prop="item.prop" :label="item.label"
            ...
            <!-- 分页组件 -->
            <Pagination :total="totalOne" :page.sync="pageIndexOne" :limit.sync="pageSizeOne"
              @pagination="getTableDataOne"></Pagination>
        ...
        <el-card style="margin-top:30px;">
          ...
          <div>
            <el-table :data="tableDataTopIdea" border>
              <el-table-column type="index" label="序号" width="50" align="center"></el-table-column>
              <el-table-column v-for="(item, index) in columnTopIdea" :key="index" :prop="item.prop" :label="item.label"
                align="center" :width="item.width ? item.width : ''"
                :show-overflow-tooltip="item.prop == 'remark' ? true : false">
                <template slot-scope="scope">
                  <span v-if="item.isSlot">
            ...
            <!-- 分页组件 -->
            <Pagination :total="totalTwo" :page.sync="pageIndexTwo" :limit.sync="pageSizeTwo"
